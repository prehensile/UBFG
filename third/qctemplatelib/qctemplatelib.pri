...
win32 {
    ...
    INCLUDEPATH += $$PWD/$$CTEMPLATE_SRC/windows    
    INCLUDEPATH += $$PWD/$$CTEMPLATE_SRC
...
linux-g++ {
    ...
    INCLUDEPATH += $$PWD/$$CTEMPLATE_SRC/linux-g++
    INCLUDEPATH += $$PWD/$$CTEMPLATE_SRC
...
mac {
    QMAKE_CXXFLAGS_WARN_ON += -Wno-unused-parameter -Wno-sign-compare -fdiagnostics-show-option    

    INCLUDEPATH += $$PWD/$$CTEMPLATE_SRC/macx
    INCLUDEPATH += $$PWD/$$CTEMPLATE_SRC

    CTEMPLATE_HEADERS_DIR = $$CTEMPLATE_SRC/ctemplate

    HEADERS += $$CTEMPLATE_SRC/macx/config.h 
}
